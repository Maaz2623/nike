...
const Hero = () => {
  const [bigShoeImg, setBigShoeImg] = useState("/images/big-shoe1.png");

  return (
    <section
      id="home"
      className="w-full gap-10 max-container flex xl:flex-row flex-col justify-center min-h-screen p-2"
    >
